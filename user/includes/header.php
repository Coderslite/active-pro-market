                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><img src="images/<?php echo $row['email'].'/'.$row['image']?>"
                                    alt="user" class="profile-pic mr-2">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="deposit.php" aria-expanded="false"><i class="mr-3 fas fa-arrow-circle-down text-success"
                                    aria-hidden="true"></i><span class="hide-menu">Deposit</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="withdraw.php" aria-expanded="false"><i class="mr-3  fas fa-arrow-circle-up text-danger"
                                    aria-hidden="true"></i><span class="hide-menu">Withdrawal</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="withdrawal_history.php" aria-expanded="false"><i class="mr-3 fa fa-columns"
                                    aria-hidden="true"></i><span class="hide-menu">Withdrawal History</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="deposit_history.php" aria-expanded="false"><i class="mr-3 fa fa-info-circle"
                                    aria-hidden="true"></i><span class="hide-menu">Deposit History</span></a></li>
