                        ...
                        <div class="service breadcrumb-txt">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-sm-10">
                                    <h1>We are 100%Trusted Trading Broker</h1>
                                ...
                                <div class="col-md-4">
                                    <div class="single-reason">
                                        ...
                                        <div class="reason-txt">
                                            <h4>Inspired</h4>
                                            <p>Want more out of your forex trading? Our Loyalty Cashback promotion has you covered (T&Cs apply).</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="single-reason">
                                        ...
                                        <div class="reason-txt">
                                            <h4>Flexible</h4>
                                            <p>We cater to all experience levels. Whether you are new to trading, or a seasoned veteran, we have what you need.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="single-reason">
                                        <div class="about-icon-wrapper"> <i class="flaticon-arrow-on-the-center-of-the-target"></i> </div>
                                        <div class="reason-txt">
                                            <h4>Trusted</h4>
                                            <p>We are one of the world’s most trusted brokers. Trade and invest with one of the most trusted names in the business.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 first">
                            <div class="container-fluid p-5">
                                <h4>Specialised help and knowledge when you need it</h4>
                                <p class="lead">
                                    Our clients are our number one priority, which is why we have experts available to answer all your questions by, email and live chat.
                                    Our offices all over the world offer specialised help, advice and guidance when you need it.
                                </p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="cta-content">
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-5 contact-btn-wrapper"><a class="boxed-btn contact-btn" href="contact.php"><span>Contact Us</span></a></div>
                </div>
            </div>
        </div>
    </div>
